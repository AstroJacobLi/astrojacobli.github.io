...
- `alf` (developed by Charlie Conroy and Pieter van Dokkum) is able to fit a two burst star formation history, the redshift, velocity dispersion, overall metallicity [Z/H], 18 individual element abundances, several IMF parameters, and a variety of nuisance parameters. This paper uses top-hat priors for most of parameters.
...
- "Both BCGs+ICL structures have rising velocity dis- persion profiles, suggesting that stars in the ICL trace the potential of the Coma cluster instead of any indi- vidual galaxy. " "nearly flat stellar age profiles in ETGs" "The massive ETGs in the central regions of galaxy clusters grow by **accreting preferentially old stellar systems**"
