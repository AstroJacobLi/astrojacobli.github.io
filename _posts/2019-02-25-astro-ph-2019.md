...
{% include image.html url="/images/cooking/GW-spectrum.png" caption="Gravitational wave spectrum showing wavelength and frequency along with some anticipated sources and the kind of detectors one might use. Credit: NASA Goddard Space Flight Center." width=400 align="right" %}
- The coalescences between stellar mass black holes produces GW with the amplitude of $$h\sim 10^{-21}$$. 
