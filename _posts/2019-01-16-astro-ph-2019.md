...
- Most interestingly, they remind of the stellar mass - halo mass relation. If the x-axis is stellar mass and y-axis is halo mass, the SMHM relation resembles this stellar mass - size diagram in $$r_{80}$$. So what's the physics behind this? First, the halo mass is proportional to the cubed virial radius $$R_{\mathrm{vir}}$$. And if $$r_{80}$$ is proportional to $$R_{\mathrm{vir}}$$, then it's reasonable that $$r_{80}$$ is a proxy of halo mass. So they just fit this coefficient for the most nearby redshift bin and find $$r_{80} = 0.047 R_{\mathrm{vir}}$$. Assuming this holds for all redshift ranges, they plot SMHM relation predicted by $$r_{80}$$, which is now a proxy of halo mass. They find it's good to $$z\sim 2$$.
