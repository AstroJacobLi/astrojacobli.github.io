...
- Chap 1
  ...
  - {% include image.html url="/images/astro-ph/CS231n-Lec3-1.png" caption="Loss and regularization" width=350 align="right" %}
...
- Lecture3:
  ...
  - Softmax loss (**cross-entropy loss**):  - log probability = - log (normalize(exp(score_of_true_class))). Softmax loss is sensitive to a little change in the input image (thus the score)
  - ![image-20200831160357338](/Users/jiaxuanli/Library/Application Support/typora-user-images/image-20200831160357338.png)
  - 
