...
Please check out the 3-D environment of Hedgehog using this interactive plot: [Hedgehog Environment](https://astrojacobli.github.io/research/Hedgehog/). The YouTube video below also nicely introduces the discovery of Hedgehog (made by a YouTuber, not me!).
<center>
